...
USAGE_LOGGING__DEVICE_ID = "device_id"
USAGE_LOGGING__TIMESTAMP = "timestamp"
USAGE_LOGGING__SOCKET_ID = "socket_id"
USAGE_LOGGING__SESSION_ID = "session_id"
USAGE_LOGGING__CONSUMPTION = "consumption"
USAGE_LOGGING__CURRENT = "current"
USAGE_LOGGING__VOLTAGE = "voltage"
USAGE_LOGGING__DURATION = "duration"
USAGE_LOGGING__IS_COMPLETED = "is_completed"
USAGE_LOGGING__AUTO_COMPLETION = "auto_completion"
USAGE_LOGGING__API_RESPONSE = "api_response"
USAGE_LOGGING__RESPONSE_CODE = "response_code"

REQUIRED_FIELDS_LIST__USAGE_LOGGING = [
    USAGE_LOGGING__DEVICE_ID,
    USAGE_LOGGING__TIMESTAMP,
    USAGE_LOGGING__SOCKET_ID,
    USAGE_LOGGING__SESSION_ID,
    USAGE_LOGGING__CONSUMPTION,
    USAGE_LOGGING__CURRENT,
    USAGE_LOGGING__VOLTAGE,
    USAGE_LOGGING__DURATION,
    USAGE_LOGGING__IS_COMPLETED,
    USAGE_LOGGING__AUTO_COMPLETION
]

# Ping Logging Constants
PING_LOGGING = "ping_logging"
PING_LOGGING__DEVICE_ID = "device_id"
PING_LOGGING__SOCKET_STATUS = "socket_status"
PING_LOGGING__SESSION_ID = "session_id"
PING_LOGGING__BOX_OPEN_REQUEST = "box_open_request"
PING_LOGGING__CREDIT = "credit"

REQUIRED_FIELDS_LIST__PING_LOGGING = [
    PING_LOGGING__DEVICE_ID,
    PING_LOGGING__SOCKET_STATUS,
    PING_LOGGING__SESSION_ID,
    PING_LOGGING__BOX_OPEN_REQUEST,
    PING_LOGGING__CREDIT
]
