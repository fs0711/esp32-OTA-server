...
CODE_AUTHENTICATION_FAILED = 401
CODE_AUTHORIZATION_FAILED = 403
...
MESSAGE_INVALID_CHECKSUM = "Checksum mismatch. Provided: {}, Calculated: {}"
...
MESSAGE_INVALID_PHONENUMBER = "No lead found for this number"
MESSAGE_DUPLICATE_ENTRY = "Record Already Exists"
