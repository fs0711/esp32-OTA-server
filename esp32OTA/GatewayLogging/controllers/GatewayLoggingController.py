...
from esp32OTA.GatewayLogging.models.GatewayLogging import GatewayLogging
from esp32OTA.generic.services.utils import constants, response_codes, response_utils, common_utils, pipeline


class GatewayLoggingController(Controller):
    ...
    def log_gateway_activity(cls, payload, log_type):
        ...
        """
        # Ensure payload is a dictionary for DictField
